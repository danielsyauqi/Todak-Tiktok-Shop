            ...
            while(key!=0){
                ...
                if(key == 1){
                    ...
                    while(!CustomerQueue.isEmpty()){
                        obj = (Customer)CustomerQueue.dequeue();
                    ...
                    //restore back to main queue list from temp queue
                ...
                if(key == 2){
                    ...
                    while(!CustomerQueue.isEmpty()){
                        obj = (Customer)CustomerQueue.dequeue();
                        System.out.println("["+count+"] "+obj.getCustName());
                        count++;
                        tempQueue.enqueue(obj);
                    }
                    //restore back from queue
                    while(!tempQueue.isEmpty()){
                        CustomerQueue.enqueue(tempQueue.dequeue());
                    }
                    ...
                    //Special queue list for deletion process
                    Queue deletedQueue = new Queue();
                    
                    //Delete Process
                    Customer delObj;
                    
                    //Condition for certain element for being deleted
                    int countDelete=0;
                    while(!CustomerQueue.isEmpty()){
                        delObj = (Customer)CustomerQueue.dequeue();
                        if(countDelete==deleteIndex2){
                            deletedQueue.enqueue(delObj);
                        }
                        else{
                        tempQueue.enqueue(delObj);
                        }
                        countDelete++;
                    }
                    while(!tempQueue.isEmpty()){
                    ...
                    deletedQueue.dequeue();
                    
                    //print process after delete
                    int count2 = 1;
                    while(!CustomerQueue.isEmpty()){
                        obj = (Customer)CustomerQueue.dequeue();
                        System.out.println("["+count2+"] "+obj.getCustName());
                        count2++;
                        tempQueue.enqueue(obj);
                    }
                    //restore back from queue
                ...
                if(key==4){
                    ...
                    //counting items
                    while(!CustomerQueue.isEmpty()){
                        popularObj = (Customer)CustomerQueue.dequeue();
                ...
                if(key==5){
                    ...
                    while(!CustomerQueue.isEmpty()){
                        saleObj = (Customer)CustomerQueue.dequeue();
